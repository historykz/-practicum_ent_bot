...
# Короткое имя мини-приложения (то, что стоит после имени бота в ссылке
# t.me/<бот>/<короткое_имя>). Ссылки для канала ведут именно в приложение:
# человек открывает его прямо в Telegram и входит автоматически, без
# отдельной регистрации на сайте.
WEB_APP_SHORT_NAME: str = os.getenv(
    "WEB_APP_SHORT_NAME", "practicumentbotproductionupra")
