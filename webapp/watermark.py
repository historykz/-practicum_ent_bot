...
<text x="10" y="60" font-family="sans-serif" font-size="15" fill="#7d8598" fill-opacity="0.32"
      transform="rotate(-28 10 60)">{text}</text>
<text x="10" y="170" font-family="sans-serif" font-size="15" fill="#7d8598" fill-opacity="0.32"
